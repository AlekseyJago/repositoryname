...
bnt_left=QPushButton('Лево')
bnt_right=QPushButton('Право')
...
row_tools.addWidget(bnt_left)
row_tools.addWidget(bnt_right)
...
bnt_left.clicked.connect(workimage.do_left)
bnt_right.clicked.connect(workimage.do_right)
